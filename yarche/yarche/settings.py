...
WSGI_APPLICATION = "yarche.wsgi.application"
...
AUTHENTICATION_BACKENDS = [
    "users.auth.PlainTextPasswordBackend",
]
...
# Бухгалтерия, Коммерческий директор, Генеральный директор, Офис-менеджер, Отдел снабжения, Цифровая полиграфия, Плоттер, Покраска, Доставка, Обучение, Технический отдел
